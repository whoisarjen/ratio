<template>
  <div class="min-h-screen flex flex-col">
    <!-- Header -->
    <header class="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-surface-200/60">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <div class="flex items-center">
          <img src="/logo.png" alt="Ratio" class="h-14 w-auto -my-3 -ml-3 -mr-1" />
          <span class="text-lg font-bold text-surface-900">ratio</span>
          <span class="hidden sm:inline text-xs font-medium text-surface-400 bg-surface-100 px-2 py-0.5 rounded-md">
            Kalkulator B2B
          </span>
        </div>
        <div class="flex items-center gap-3">
          <a
            href="https://github.com/kamilowczarek/ratio"
            target="_blank"
            rel="noopener"
